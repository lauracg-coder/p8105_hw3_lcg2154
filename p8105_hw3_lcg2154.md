...
the weekdays in subsequent weeks especially week 5. Overall there is
indirect proportional relationship between weekdays and weekend: as
activity count increases during the weekends, the activity count of
weekdays decreases and vice-versa.
...
later in the 24-hour activity cycle around minute 1400. The activity
increase in the beginning and end of the activity time which accurately
represents mornings and nighttime that generally involve less activity.
...
snowfall_df = 
  ...
  geom_boxplot() +
  labs(
    title = "yearly snowfall greater than 0 and less than 100",
    x = "Year", 
